...
function start() {
	...
	# (cd ~/Library/Application\ Support/Sublime\ Text/Packages/ && rm -r User && ln -s ~/Dropbox/Apps/Sublime/User)
	...
	echo "[1] /.ssh"
	DIR="$HOME/.ssh"
	PutSymlink $DIR "ssh keys" ~/Dropbox/Apps/dot/ssh ~/.ssh


	echo "[2] .zshrc"
	DIR="$HOME/.zshrc"
	PutSymlink $DIR "zshrc" ~/Dropbox/Apps/dot/zshrc ~/.zshrc

	
	echo "[3] .zsh_history"
	DIR="$HOME/.zsh_history"
	PutSymlink $DIR "zsh_history" ~/Dropbox/Apps/dot/zsh_history ~/.zsh_history
